  ...
  <div class="w-full px-6 sm:px-10 lg:px-16 xl:px-24 2xl:px-32">
    ...
    <div class="mt-16 text-center">
      <button
        ...
        class="inline-flex items-center justify-center gap-2.5 bg-white text-slate-900 px-6 py-4 sm:px-10 sm:py-5 text-base sm:text-lg font-bold rounded-xl transition-all duration-300 hover:shadow-2xl hover:shadow-white/10 hover:-translate-y-0.5">
