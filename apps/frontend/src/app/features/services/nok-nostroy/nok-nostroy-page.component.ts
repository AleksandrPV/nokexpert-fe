...
export class NokNostroyPageComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  serviceData = {
    ...
    gosposhlina: PRICING['nok-nostroy'].gosposhlina!,
    features: [
      {
        icon: 'book-open',
        title: '600+ актуальных вопросов',
        description: 'Полная база вопросов, идентичных реальному экзамену. Регулярные обновления в соответствии с изменениями профессиональных стандартов НОСТРОЙ.'
      },
      {
        icon: 'monitor',
      ...
      },
      {
        ...
        description: 'Индивидуальные разборы сложных тем с практикующими специалистами строительной отрасли. Разбор типичных ошибок.'
      },
      {
        icon: 'shield-check',
      ...
      },
      {
        ...
        description: 'Помощь в сборе, оформлении и проверке всех необходимых документов для подачи в ЦОК. Включая портфолио работ.'
      },
      {
        icon: 'headphones',
        title: 'Сопровождение до результата',
        description: 'Персональный куратор на каждом этапе: от первой консультации до получения свидетельства и внесения в НРС.'
      }
    ],
    levels: [
      {
        ...
        description: 'Квалифицированные рабочие строительных специальностей с опытом от 3 лет',
        examples: ['Каменщик', 'Бетонщик', 'Арматурщик', 'Сварщик', 'Монтажник']
      },
      {
        level: '6',
        title: 'Инженерно-технические работники',
        description: 'Техники, мастера и специалисты среднего звена с профильным образованием',
        examples: ['Техник-строитель', 'Мастер строительных работ', 'Прораб', 'Бригадир']
      },
      {
        level: '7',
        title: 'Главные инженеры и архитекторы',
        description: 'Руководители проектов, ГИП и ГАП с высшим образованием и стажем от 5 лет',
    ...
    process: [
      ...
      },
      {
        step: '02',
        title: 'Подготовка документов',
        description: 'Помогаем собрать полный пакет документов: диплом, стаж, портфолио. Проверяем на соответствие требованиям.'
      },
      {
        step: '03',
        title: 'Теоретическая подготовка',
        description: 'Доступ к тренажёру с 600+ вопросами. Разбор сложных тем с экспертом. Симуляция экзаменационных условий.'
      },
      {
        step: '04',
      ...
      },
      {
        ...
        description: 'Получаете свидетельство о квалификации, действующее 5 лет. Помогаем с внесением данных в НРС НОСТРОЙ.'
      }
    ],
    documents: [
    ...
    guarantees: [
      {
        ...
        number: '98%',
        description: 'Наших клиентов успешно сдают экзамен НОК НОСТРОЙ с первого раза. При несдаче --- бесплатная повторная подготовка.'
      },
      {
        icon: 'award',
      ...
      },
      {
        ...
        number: '3 000+',
        description: 'Специалистов подготовлено к экзамену НОК за 7 лет работы. Практикующие эксперты строительной отрасли.'
      },
      {
        icon: 'clock',
    ...
    faqItems: [
      {
        question: 'Что такое НОК НОСТРОЙ и зачем она нужна?',
        answer: 'НОК НОСТРОЙ --- это независимая оценка квалификации специалистов строительной отрасли, проводимая в соответствии с Федеральным законом 238-ФЗ. Свидетельство НОК необходимо для включения в Национальный реестр специалистов (НРС) НОСТРОЙ и является обязательным для занятия руководящих должностей на строительных объектах.'
      },
      {
        question: 'Сколько времени занимает подготовка к экзамену?',
        answer: 'Стандартная программа подготовки рассчитана на 30 дней. Для тех, кому нужен быстрый результат, доступен интенсивный курс за 14 дней. Также возможен индивидуальный график подготовки с учётом вашей занятости.'
      },
      {
        question: 'Как проходит экзамен НОК НОСТРОЙ?',
        answer: 'Экзамен проходит в аккредитованном Центре оценки квалификаций (ЦОК). Состоит из теоретической части (тестирование по профессиональным стандартам) и может включать практическую часть в зависимости от квалификации. Результаты известны в течение 30 рабочих дней.'
      },
      {
