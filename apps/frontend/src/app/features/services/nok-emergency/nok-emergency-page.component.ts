...
export class NokEmergencyPageComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  serviceData = {
    price: PRICING['nok-emergency'].price,
    duration: PRICING['nok-emergency'].duration,
    gosposhlina: PRICING['nok-emergency'].gosposhlina!,
    features: [
      {
        icon: 'book-open',
        title: '500+ актуальных вопросов',
        description: 'Полная база вопросов для подготовки к теоретической части экзамена НОК МЧС. Регулярные обновления в соответствии с профессиональными стандартами.'
      },
      {
        icon: 'monitor',
        title: 'Симулятор экзамена',
        description: 'Пробный экзамен с реальными заданиями, контролем времени и мгновенной проверкой. Полное воспроизведение условий ЦОК.'
      },
      {
        icon: 'users',
        title: 'Консультации экспертов',
        description: 'Индивидуальные разборы сложных тем с практикующими специалистами аварийно-спасательных служб. Разбор типичных ошибок.'
      },
      {
        icon: 'shield-check',
      ...
      },
      {
        ...
        description: 'Помощь в сборе, оформлении и проверке всех необходимых документов для подачи в ЦОК. Включая медицинские справки.'
      },
      {
        icon: 'headphones',
    ...
    levels: [
      {
        ...
        description: 'Специалисты, непосредственно выполняющие аварийно-спасательные и неотложные работы',
        examples: ['Спасатель', 'Пожарный', 'Водитель пожарного автомобиля', 'Диспетчер']
      },
      {
        level: '6',
        title: 'Специалисты и техники',
        description: 'Специалисты по ГОЧС, техники, инспекторы и координаторы аварийно-спасательных операций',
        examples: ['Инспектор ГПН', 'Техник по пожарной безопасности', 'Специалист по ГОЧС', 'Координатор ЧС']
      },
      {
        level: '7',
        title: 'Руководители и эксперты',
        description: 'Руководители подразделений, эксперты, начальники аварийно-спасательных служб',
        examples: ['Начальник караула', 'Эксперт по ЧС', 'Руководитель службы ГОЧС', 'Начальник отряда']
      }
    ],
    process: [
      {
      ...
      },
      {
        step: '02',
        title: 'Подготовка документов',
        description: 'Помогаем собрать полный пакет документов: диплом, стаж, медицинская справка, справка об отсутствии судимости.'
      },
      {
        step: '03',
        title: 'Теоретическая подготовка',
        description: 'Доступ к тренажёру с 500+ вопросами по аварийно-спасательным работам. Разбор сложных тем с экспертом.'
      },
      {
        step: '04',
      ...
      },
      {
        ...
        description: 'Получаете свидетельство о квалификации, действующее 5 лет. Помогаем с внесением данных в реестр.'
      }
    ],
    documents: [
      ...
      'Медицинская справка о годности к работе',
    ...
    guarantees: [
      ...
      },
      {
        ...
        number: '200+',
        description: 'Специалистов аварийно-спасательных служб подготовлено к экзамену НОК. Практикующие эксперты области ЧС.'
      },
      {
        icon: 'clock',
        title: 'Быстрый результат',
        number: '45',
        description: 'Дней в среднем от начала подготовки до получения свидетельства. Доступен интенсивный курс за 21 день.'
      }
    ],
    faqItems: [
      {
        question: 'Что такое НОК МЧС и зачем она нужна?',
        answer: 'НОК МЧС --- это независимая оценка квалификации специалистов аварийно-спасательных и других неотложных работ, проводимая в соответствии с Федеральным законом 238-ФЗ. Свидетельство необходимо для допуска к выполнению аварийно-спасательных работ, включая горноспасательные, газоспасательные и противофонтанные работы.'
      },
      {
        question: 'Чем НОК МЧС отличается от НОК ОПБ?',
        answer: 'НОК МЧС --- это оценка квалификации специалистов аварийно-спасательных и других неотложных работ (спасатели, пожарные, специалисты ГОЧС). НОК ОПБ --- для ответственных за обеспечение пожарной безопасности на объектах (инженеры ПБ, ответственные лица). Разные профессиональные стандарты и экзаменационные вопросы.'
      },
      {
        question: 'Сколько времени занимает подготовка к экзамену?',
        answer: 'Стандартная программа подготовки рассчитана на 45 дней. Для тех, кому нужен быстрый результат, доступен интенсивный курс за 21 день. Также возможен индивидуальный график подготовки с учётом сменного режима работы.'
      },
      {
        question: 'Как проходит экзамен НОК МЧС?',
        answer: 'Экзамен проходит в аккредитованном Центре оценки квалификаций (ЦОК). Состоит из теоретической части (тестирование по профессиональным стандартам для аварийно-спасательных работ) и может включать практическую часть. Результаты известны в течение 30 рабочих дней.'
      },
      {
        question: 'Сколько действует свидетельство НОК?',
  ...
  ngOnInit(): void {
    ...
    this.servicesService.getServiceById('nok-emergency').subscribe((service: any) => {
      if (service) {
