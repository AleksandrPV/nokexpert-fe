...
export class NokNoprizPageComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  serviceData = {
    ...
    gosposhlina: PRICING['nok-nopriz'].gosposhlina!,
    features: [
      {
        icon: 'book-open',
        title: '800+ актуальных вопросов',
        description: 'Полная база вопросов по проектированию и изысканиям, идентичных реальному экзамену. Регулярные обновления по профстандартам НОПРИЗ.'
      },
      {
        icon: 'monitor',
        title: 'Симулятор экзамена',
        description: 'Пробный экзамен с реальными заданиями НОПРИЗ, контролем времени и мгновенной проверкой. Полное воспроизведение условий ЦОК.'
      },
      {
        icon: 'users',
        title: 'Консультации экспертов',
        description: 'Индивидуальные разборы сложных тем с практикующими проектировщиками и изыскателями. Нормативная база, BIM, техрегламенты.'
      },
      {
        icon: 'shield-check',
      ...
      {
        icon: 'file-check',
        title: 'Помощь с портфолио',
        description: 'Структурирование и оформление проектов для портфолио НОПРИЗ. Проверка на соответствие требованиям центра оценки.'
      },
      {
        icon: 'headphones',
        title: 'Сопровождение до результата',
        description: 'Персональный куратор на каждом этапе: от первой консультации до получения свидетельства и внесения в НРС НОПРИЗ.'
      }
    ],
    levels: [
      {
        level: '6',
        title: 'Инженер-проектировщик / изыскатель',
        description: 'Специалисты с профильным образованием и опытом работы в проектировании или инженерных изысканиях',
        examples: ['Инженер-проектировщик', 'Инженер-изыскатель', 'Архитектор', 'Инженер-геодезист', 'Инженер-геолог']
      },
      {
        level: '7',
        title: 'ГИП / ГАП',
        description: 'Главные инженеры и архитекторы проектов с высшим образованием и стажем от 5 лет',
        examples: ['Главный инженер проекта (ГИП)', 'Главный архитектор проекта (ГАП)', 'Руководитель проекта']
      },
      {
        level: '8',
        title: 'Руководители проектных организаций',
        description: 'Руководители и эксперты проектных и изыскательских организаций высшего уровня',
        examples: ['Руководитель проектного отдела', 'Эксперт по проектированию', 'Директор проектной организации']
      }
    ],
    process: [
      {
      ...
      },
      {
        ...
        description: 'Помогаем структурировать и оформить проекты для портфолио НОПРИЗ. Проверяем на соответствие требованиям.'
      },
      {
        step: '03',
      ...
      },
      {
        ...
        description: 'Доступ к тренажёру с 800+ вопросами. Разбор нормативной базы, BIM-технологий и техрегламентов с экспертом.'
      },
      {
        step: '05',
      ...
      },
      {
        ...
        description: 'Записываем на экзамен в ЦОК. Получаете свидетельство о квалификации на 5 лет. Помогаем с внесением в НРС НОПРИЗ.'
      }
    ],
    documents: [
      'Паспорт гражданина РФ (все страницы)',
      'Диплом о высшем образовании (строительное, архитектурное)',
    ...
    guarantees: [
      {
        ...
        number: '97%',
        description: 'Наших клиентов успешно сдают экзамен НОК НОПРИЗ с первого раза. При несдаче --- бесплатная повторная подготовка.'
      },
      {
        icon: 'award',
        title: 'Аккредитованные ЦОК',
        number: '12+',
        description: 'Работаем только с центрами оценки квалификаций, аккредитованными Национальным агентством развития квалификаций.'
      },
      {
        icon: 'users',
        title: 'Опытные эксперты',
        number: '1 500+',
        description: 'Проектировщиков и изыскателей подготовлено к экзамену НОК за 7 лет работы. Практикующие эксперты отрасли.'
      },
      {
        icon: 'clock',
        title: 'Быстрый результат',
        number: '35',
        description: 'Рабочих дней в среднем от начала подготовки до получения свидетельства. Доступен интенсивный курс за 14 дней.'
      }
    ],
    faqItems: [
      {
        question: 'Чем НОК НОПРИЗ отличается от НОК НОСТРОЙ?',
        answer: 'НОК НОСТРОЙ --- для специалистов строительства (производство работ), а НОК НОПРИЗ --- для проектировщиков и инженеров-изыскателей (проектирование зданий и сооружений). Разные профессиональные стандарты, разные вопросы экзамена и разные требования к портфолио.'
      },
      {
        question: 'Сколько времени занимает подготовка к экзамену?',
        answer: 'Стандартная программа подготовки рассчитана на 35 рабочих дней. Для тех, кому нужен быстрый результат, доступен интенсивный курс за 14 дней. Также возможен индивидуальный график с учётом вашей занятости.'
      },
      {
        question: 'Нужно ли портфолио для НОК НОПРИЗ?',
        answer: 'Да, портфолио проектов --- обязательная часть квалификационной оценки НОПРИЗ. Необходимо предоставить 3-5 реализованных проектов. Мы помогаем структурировать и оформить портфолио в соответствии с требованиями центра оценки.'
      },
      {
        question: 'Как проходит экзамен НОК НОПРИЗ?',
        answer: 'Экзамен проходит в аккредитованном ЦОК. Состоит из теоретической части (тестирование по нормативной базе проектирования, техрегламентам, BIM) и оценки портфолио. Результаты известны в течение 30 рабочих дней.'
      },
      {
        question: 'Сколько действует свидетельство НОК НОПРИЗ?',
      ...
      },
      {
        ...
        answer: 'Да, программа разработана для работающих специалистов. Онлайн-доступ к тренажёру 24/7, вечерние и выходные консультации с экспертами, возможность учиться в удобном темпе с мобильного устройства.'
      }
    ],
    relatedServices: [
      {
  ...
  ngOnInit(): void {
    ...
    this.servicesService.getServiceById('nok-design').subscribe((service: any) => {
      if (service) {
