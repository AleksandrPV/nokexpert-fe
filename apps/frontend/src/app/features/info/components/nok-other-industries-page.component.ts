...
export class NokOtherIndustriesPageComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  industries = [
    ...
    },
    {
      ...
      description: 'Спасатели, специалисты по гражданской обороне, инспекторы пожарного надзора. Аттестация спасателей проводится по отдельным нормативным актам МЧС.',
  ...
  processSteps = [
    ...
    },
    {
      ...
      description: 'При успешной сдаче выдаётся свидетельство о квалификации сроком на 3–5 лет в зависимости от квалификации. Данные вносятся в реестр сведений о проведении НОК.'
    }
  ];

  keyStats = [
    { number: '40+', label: 'Отраслей', description: 'охвачено системой НОК по 238-ФЗ' },
    { number: '46', label: 'Советов (СПК)', description: 'по профессиональным квалификациям' },
    { number: '400+', label: 'Центров ЦОК', description: 'аккредитовано по всей России' },
    { number: '3–5 лет', label: 'Срок действия', description: 'свидетельства о квалификации' }
  ];
  ...
  faqItems = [
    ...
    },
    {
      ...
      answer: 'Стоимость варьируется от 18 000 до 30 000 рублей в зависимости от отрасли, уровня квалификации и региона. Работодатель может отнести расходы на НОК к прочим расходам, уменьшающим налогооблагаемую прибыль. Работник при самостоятельной оплате может получить социальный налоговый вычет по НДФЛ.'
    },
    {
