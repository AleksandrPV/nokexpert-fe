...
export class PortfolioGuidePageComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  documents = [
    ...
    },
    {
      ...
      description: 'Заверенная копия трудовой книжки, подтверждающая стаж работы по специальности. Минимальный стаж --- от 3 до 10 лет в зависимости от уровня квалификации.',
      color: 'emerald'
    },
    {
      number: '03',
