  ...
  <div class="w-full px-6 sm:px-10 lg:px-16 xl:px-24 2xl:px-32">
    ...
    <div class="mt-12 bg-white rounded-2xl p-10 ring-1 ring-slate-200">
      ...
      <p class="text-lg text-slate-600 leading-relaxed">
        Согласно 238-ФЗ, свидетельство о квалификации действует <strong class="text-slate-900">от 3 до 5 лет</strong> (срок устанавливается для каждой квалификации отдельно).
        По истечении этого срока специалист обязан повторно пройти процедуру независимой оценки квалификации.
        Данные о выданных свидетельствах вносятся в реестр сведений о проведении независимой оценки квалификации,
        который ведётся в соответствии со статьёй 10 закона.
      </p>
    </div>
  </div>
</section>
...
export class NokLegislationPageComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  fzArticles = [
    ...
    },
    {
      ...
      description: 'Определяет участников системы: федеральный орган исполнительной власти (Минтруд), Национальный совет, НАРК, советы по профквалификациям, центры оценки квалификаций (ЦОК), работодатели и соискатели.'
    },
    {
      icon: 'users',
      label: 'Статья 4',
      title: 'Проведение НОК',
      description: 'Регламентирует порядок проведения: подача заявления, проведение профессионального экзамена, оценка результатов, выдача свидетельства или заключения о несоответствии.'
    },
    {
      icon: 'file-check',
      label: 'Статьи 5–8',
      title: 'Институты системы НОК',
      description: 'Определяют полномочия и функции: Национальный совет при Президенте (ст. 5), НАРК (ст. 6), советы по профквалификациям (ст. 7), центры оценки квалификаций (ст. 8).'
    },
    {
      icon: 'database',
      label: 'Статья 10',
      title: 'Информационное обеспечение НОК',
      description: 'Устанавливает порядок ведения реестра сведений о проведении независимой оценки квалификации, куда вносятся данные обо всех выданных свидетельствах НОК.'
    }
  ];
  ...
  recentChanges = [
    ...
    },
    {
      ...
      items: [
        ...
        'Переход на электронный формат ведения реестра НОК',
  ...
  faqItems = [
    ...
    },
    {
      ...
      answer: 'Согласно статьям 196 и 187 Трудового кодекса РФ, работодатель имеет право направить работника на НОК с его письменного согласия. При этом за работником сохраняются место работы и средняя заработная плата (ст. 187), а при направлении в другую местность оплачиваются командировочные расходы.'
    },
    {
