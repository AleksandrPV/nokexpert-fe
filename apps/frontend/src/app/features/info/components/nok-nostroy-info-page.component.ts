...
export class NokNostroyInfoPageComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  aboutCards = [
    ...
    },
    {
      ...
      description: 'НОСТРОЙ образовано 4 ноября 2009 года в результате реформы системы допусков в строительстве. Заменило государственное лицензирование на систему саморегулирования. Объединяет более 200 строительных СРО по всей России.',
      color: 'emerald'
    },
    {
      icon: 'shield-check',
  ...
  professionalStandards = [
    ...
    {
      code: '16.032',
      title: 'Специалист в области строительного контроля',
      levels: '6, 7',
  ...
  examDetails = [
    ...
    },
    {
      ...
      description: 'Для успешной сдачи необходимо набрать не менее 70% правильных ответов в теоретической части и получить положительную оценку за практическую часть. Результаты объявляются в течение 5 рабочих дней.'
    },
    {
      icon: 'map-pin',
      title: 'Где сдавать',
  ...
  keyStats = [
    { number: '200+', label: 'СРО в составе', description: 'Саморегулируемых организаций объединено в НОСТРОЙ' },
    { number: '2009', label: 'Год основания', description: 'Создание Национального объединения строителей' },
    { number: '5 лет', label: 'Срок действия', description: 'Срок действия свидетельства о квалификации НОК' },
    { number: '70%', label: 'Проходной балл', description: 'Минимальный результат для успешной сдачи экзамена' }
  ];
  ...
  faqItems = [
    ...
    },
    {
      ...
      answer: 'Свидетельство о квалификации действует 5 лет с момента выдачи. По истечении срока необходимо повторно пройти процедуру оценки квалификации. Информация о выданных свидетельствах хранится в Федеральном реестре сведений о квалификациях (ФРСК).'
    },
    {
    ...
    },
    {
      ...
      answer: 'При несдаче экзамена соискатель имеет право на повторную попытку. Ограничений по количеству попыток нет, но каждая попытка оплачивается отдельно. Мы предоставляем гарантию: при несдаче после полной подготовки по нашей программе --- бесплатная повторная подготовка и сопровождение до успешной сдачи.'
    },
    {
