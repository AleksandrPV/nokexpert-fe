...
export class ExamPreparationPageComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  whyPrepareBenefits = [
    {
      ...
      description: 'Подготовленные кандидаты значительно чаще сдают экзамен с первой попытки. Без целенаправленной подготовки процент успешной сдачи составляет лишь 30–40%.',
      color: 'violet'
    },
    {
      icon: 'clock',
  ...
  examTopics = [
    ...
    {
      icon: 'landmark',
      title: '238-ФЗ и 315-ФЗ',
      description: 'Законодательство о независимой оценке квалификаций (238-ФЗ) и о саморегулируемых организациях (315-ФЗ).'
    }
  ];

  // --- EXAM STATS ---
  examStats = [
    { value: '50', label: 'Вопросов', note: 'в теоретической части' },
    { value: '60 мин', label: 'Длительность', note: 'теоретической части' },
    { value: '72%', label: 'Порог сдачи', note: 'правильных ответов (36 из 50)' },
    { value: '3–5 лет', label: 'Срок действия', note: 'свидетельства НОК' }
  ];
  ...
  faqItems = [
    ...
    },
    {
      ...
      answer: 'Для успешной сдачи теоретической части экзамена необходимо ответить правильно минимум на 72% вопросов (36 из 50 для НОСТРОЙ). Рекомендуем стремиться к результату не менее 85% в тренажёре, чтобы иметь запас на случай волнения на реальном экзамене.'
    },
    {
